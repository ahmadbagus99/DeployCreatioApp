...
# ─────────────────────────────────────────
# USAGE: ./deploy-local-mac.sh <instance_name>
# Example: ./deploy-local-mac.sh jamkrida
# ─────────────────────────────────────────

if [ -z "$1" ]; then
  echo "❌ Instance name required!"
  echo "   Usage: ./deploy-local-mac.sh <instance_name>"
  echo "   Example: ./deploy-local-mac.sh jamkrida"
  exit 1
fi
